...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	sbSizer1 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, wxT("Tryb rysowania") ), wxHORIZONTAL );
	
	sbSizer1->SetMinSize( wxSize( -1,60 ) ); 
	m_cb_Kontur = new wxCheckBox( sbSizer1->GetStaticBox(), wxID_ANY, wxT("Kontur"), wxDefaultPosition, wxDefaultSize, 0 );
	m_cb_Kontur->SetValue(true); 
	sbSizer1->Add( m_cb_Kontur, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_cb_Mapa = new wxCheckBox( sbSizer1->GetStaticBox(), wxID_ANY, wxT("Mapa"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer1->Add( m_cb_Mapa, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_rb_NC = new wxRadioButton( sbSizer1->GetStaticBox(), wxID_ANY, wxT("N/C"), wxDefaultPosition, wxDefaultSize, 0 );
	m_rb_NC->SetValue( true ); 
	m_rb_NC->Enable( false );
	
	sbSizer1->Add( m_rb_NC, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_rb_NZC = new wxRadioButton( sbSizer1->GetStaticBox(), wxID_ANY, wxT("N/Z/C"), wxDefaultPosition, wxDefaultSize, 0 );
	m_rb_NZC->Enable( false );
	
	sbSizer1->Add( m_rb_NZC, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_rb_Na_szaro = new wxRadioButton( sbSizer1->GetStaticBox(), wxID_ANY, wxT("Na szaro"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer2 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, wxT("Wybór funkcji") ), wxHORIZONTAL );
	
	m_tb_function_1 = new wxToggleButton( sbSizer2->GetStaticBox(), wxID_ANY, wxT("1"), wxDefaultPosition, wxSize( 27,27 ), 0 );
	sbSizer2->Add( m_tb_function_1, 0, wxALL, 5 );
	
	
	sbSizer2->Add( 0, 0, 1, wxEXPAND, 5 );
	
	m_tb_function_2 = new wxToggleButton( sbSizer2->GetStaticBox(), wxID_ANY, wxT("2"), wxDefaultPosition, wxSize( 27,27 ), 0 );
	sbSizer2->Add( m_tb_function_2, 0, wxALL, 5 );
	
	
	sbSizer2->Add( 0, 0, 1, wxEXPAND, 5 );
	
	m_tb_function_3 = new wxToggleButton( sbSizer2->GetStaticBox(), wxID_ANY, wxT("3"), wxDefaultPosition, wxSize( 27,27 ), 0 );
	sbSizer2->Add( m_tb_function_3, 0, wxALL, 5 );
	
	
	sbSizer2->Add( 0, 0, 1, wxEXPAND, 5 );
	
	m_tb_function_4 = new wxToggleButton( sbSizer2->GetStaticBox(), wxID_ANY, wxT("4"), wxDefaultPosition, wxSize( 27,27 ), 0 );
	...
	m_st_liczba_poziomic = new wxStaticText( this, wxID_ANY, wxT("Liczba poziomic: 5"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tb_pokaz_punkty = new wxToggleButton( this, wxID_ANY, wxT("Pokaż punkty"), wxDefaultPosition, wxDefaultSize, 0 );
