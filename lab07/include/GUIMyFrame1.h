...
public:
    ...
    void
    DrawMap(int N, float d[100][3], bool Contour, int MappingType, int NoLevels,
            bool ShowPoints);

    void Repaint();

    void drawBlueRed(wxMemoryDC &dc, double max, double d2);
    void drawBlueGreenRed(wxMemoryDC &dc, double max, double d2);
    void drawGray(wxMemoryDC &dc, double max, double d2);
};
