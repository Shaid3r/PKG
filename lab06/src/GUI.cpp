...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_b_grayscale = new wxButton( this, wxID_ANY, wxT("Grayscale"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer1->Add( m_b_grayscale, 0, wxALL, 5 );
	
	m_b_blur = new wxButton( this, wxID_ANY, wxT("Blur"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer1->Add( m_b_blur, 0, wxALL, 5 );
	
	m_b_mirror = new wxButton( this, wxID_ANY, wxT("Mirror"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer1->Add( m_b_mirror, 0, wxALL, 5 );
	
	m_b_replace = new wxButton( this, wxID_ANY, wxT("Replace"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer1->Add( m_b_replace, 0, wxALL, 5 );
	
	m_b_rescale = new wxButton( this, wxID_ANY, wxT("Rescale"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer1->Add( m_b_rescale, 0, wxALL, 5 );
	
	m_b_rotate = new wxButton( this, wxID_ANY, wxT("Rotate"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer1->Add( m_b_rotate, 0, wxALL, 5 );
	
	m_b_rotate_hue = new wxButton( this, wxID_ANY, wxT("Rotate HUE"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer1->Add( m_b_rotate_hue, 0, wxALL, 5 );
	
	m_b_mask = new wxButton( this, wxID_ANY, wxT("Mask"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer1->Add( m_b_mask, 0, wxALL, 5 );
	
	
	bSizer2->Add( gSizer1, 1, wxEXPAND, 5 );
	
	m_staticText1 = new wxStaticText( this, wxID_ANY, wxT("Jasność"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText2 = new wxStaticText( this, wxID_ANY, wxT("Kontrast"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_b_prewitt = new wxButton( this, wxID_ANY, wxT("Maska Prewitta"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer2->Add( m_b_prewitt, 0, wxALIGN_CENTER|wxALL|wxEXPAND, 5 );
	
	m_b_threshold = new wxButton( this, wxID_ANY, wxT("Próg 128"), wxDefaultPosition, wxDefaultSize, 0 );
