...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText19 = new wxStaticText( this, wxID_ANY, wxT("Translacja X:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText19->Wrap( -1 );
	fgSizer1->Add( m_staticText19, 0, wxALL, 5 );
	
	WxSB_TranslationX = new wxSlider( this, wxID_ANY, 50, 0, 100, wxDefaultPosition, wxSize(100, 30), wxSL_HORIZONTAL );
	fgSizer1->Add( WxSB_TranslationX, 0, wxALL, 5 );
	
	WxST_TranslationX = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	WxST_TranslationX->Wrap( -1 );
	WxST_TranslationX->SetMinSize( wxSize( 30,-1 ) );
	
	fgSizer1->Add( WxST_TranslationX, 0, wxALL, 5 );
	
	m_staticText21 = new wxStaticText( this, wxID_ANY, wxT("Translacja Y:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText21->Wrap( -1 );
	fgSizer1->Add( m_staticText21, 0, wxALL, 5 );
	
	WxSB_TranslationY = new wxSlider( this, wxID_ANY, 50, 0, 100, wxDefaultPosition, wxSize(100, 30), wxSL_HORIZONTAL );
	fgSizer1->Add( WxSB_TranslationY, 0, wxALL, 5 );
	
	WxST_TranslationY = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	WxST_TranslationY->Wrap( -1 );
	fgSizer1->Add( WxST_TranslationY, 0, wxALL, 5 );
	
	m_staticText23 = new wxStaticText( this, wxID_ANY, wxT("Translacja Z:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText23->Wrap( -1 );
	fgSizer1->Add( m_staticText23, 0, wxALL, 5 );
	
	WxSB_TranslationZ = new wxSlider( this, wxID_ANY, 50, 0, 100, wxDefaultPosition, wxSize(100, 30), wxSL_HORIZONTAL );
	fgSizer1->Add( WxSB_TranslationZ, 0, wxALL, 5 );
	
	WxST_TranslationZ = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	WxST_TranslationZ->Wrap( -1 );
	fgSizer1->Add( WxST_TranslationZ, 0, wxALL, 5 );
	
	m_staticText25 = new wxStaticText( this, wxID_ANY, wxT("Obrót X:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText25->Wrap( -1 );
	fgSizer1->Add( m_staticText25, 0, wxALL, 5 );
	
	WxSB_RotateX = new wxSlider( this, wxID_ANY, 50, 0, 100, wxDefaultPosition, wxSize(100, 30), wxSL_HORIZONTAL );
	fgSizer1->Add( WxSB_RotateX, 0, wxALL, 5 );
	
	WxST_RotateX = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	WxST_RotateX->Wrap( -1 );
	fgSizer1->Add( WxST_RotateX, 0, wxALL, 5 );
	
	m_staticText27 = new wxStaticText( this, wxID_ANY, wxT("Obrót Y:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText27->Wrap( -1 );
	fgSizer1->Add( m_staticText27, 0, wxALL, 5 );
	
	WxSB_RotateY = new wxSlider( this, wxID_ANY, 50, 0, 100, wxDefaultPosition, wxSize(100, 30), wxSL_HORIZONTAL );
	fgSizer1->Add( WxSB_RotateY, 0, wxALL, 5 );
	
	WxST_RotateY = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	WxST_RotateY->Wrap( -1 );
	fgSizer1->Add( WxST_RotateY, 0, wxALL, 5 );
	
	m_staticText29 = new wxStaticText( this, wxID_ANY, wxT("Obrót Z:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText29->Wrap( -1 );
	fgSizer1->Add( m_staticText29, 0, wxALL, 5 );
	
	WxSB_RotateZ = new wxSlider( this, wxID_ANY, 50, 0, 100, wxDefaultPosition, wxSize(100, 30), wxSL_HORIZONTAL );
	fgSizer1->Add( WxSB_RotateZ, 0, wxALL, 5 );
	
	WxST_RotateZ = new wxStaticText( this, wxID_ANY, wxT("0"), wxDefaultPosition, wxDefaultSize, 0 );
	WxST_RotateZ->Wrap( -1 );
	fgSizer1->Add( WxST_RotateZ, 0, wxALL, 5 );
	
	m_staticText31 = new wxStaticText( this, wxID_ANY, wxT("Skala X:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText31->Wrap( -1 );
	fgSizer1->Add( m_staticText31, 0, wxALL, 5 );
	
	WxSB_ScaleX = new wxSlider( this, wxID_ANY, 50, 0, 100, wxDefaultPosition, wxSize(100, 30), wxSL_HORIZONTAL );
	fgSizer1->Add( WxSB_ScaleX, 0, wxALL, 5 );
	
	WxST_ScaleX = new wxStaticText( this, wxID_ANY, wxT("1.0"), wxDefaultPosition, wxDefaultSize, 0 );
	WxST_ScaleX->Wrap( -1 );
	fgSizer1->Add( WxST_ScaleX, 0, wxALL, 5 );
	
	m_staticText33 = new wxStaticText( this, wxID_ANY, wxT("Skala Y:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText33->Wrap( -1 );
	fgSizer1->Add( m_staticText33, 0, wxALL, 5 );
	
	WxSB_ScaleY = new wxSlider( this, wxID_ANY, 50, 0, 100, wxDefaultPosition, wxSize(100, 30), wxSL_HORIZONTAL );
	fgSizer1->Add( WxSB_ScaleY, 0, wxALL, 5 );
	
	WxST_ScaleY = new wxStaticText( this, wxID_ANY, wxT("1.0"), wxDefaultPosition, wxDefaultSize, 0 );
	WxST_ScaleY->Wrap( -1 );
	fgSizer1->Add( WxST_ScaleY, 0, wxALL, 5 );
	
	m_staticText35 = new wxStaticText( this, wxID_ANY, wxT("Skala Z:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText35->Wrap( -1 );
	fgSizer1->Add( m_staticText35, 0, wxALL, 5 );
	
	WxSB_ScaleZ = new wxSlider( this, wxID_ANY, 50, 0, 100, wxDefaultPosition, wxSize(100, 30), wxSL_HORIZONTAL );
	fgSizer1->Add( WxSB_ScaleZ, 0, wxALL, 5 );
	
	WxST_ScaleZ = new wxStaticText( this, wxID_ANY, wxT("1.0"), wxDefaultPosition, wxDefaultSize, 0 );
	WxST_ScaleZ->Wrap( -1 );
